...
<body>
    ...
    <script>
        function initMap() {
            ...
            var map = new google.maps.Map(document.getElementById('map'), {
                center: {lat:-8.91404, lng: 13.3276},
                zoom: 10
            });
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA5M8cEKQhzyASmT9I776InU_b7fCYH4lk&callback=initMap"></script>
</body>
</html>
