                ...
                <ul>
                    @auth()
                        @if (auth()->user()->hasRole('Cliente'))
                            <li class="dropdown"><a href="#"><span>Opções de estações</span></a>
                                <ul>
                                    <!--  <li><a href="#">Estações favoritas</a></li> -->
                                    <li><a href="#">Estações próximas</a></li>
                                    <li><a href="#">Todas as estações</a></li>
