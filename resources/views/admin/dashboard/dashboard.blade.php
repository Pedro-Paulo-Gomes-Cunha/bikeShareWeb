        ...
        <div class="page-header">
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="title">
                        <h4>Bem vindo de volta <span style="font-weight: 800; color: blue; font-size: 22px;">{{auth()->user()->name}}</span></h4>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mb-30">
                <div class="card-box pd-30 height-100-p">
                    <div class="progress-box text-center">
                        ...
                        <h5 class="text-blue padding-top-10 h5">Meus Ganhos</h5>
                        <span class="d-block">80% Percentagem <i class="fa fa-line-chart text-blue"></i></span>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 mb-30">
                <div class="card-box pd-30 height-100-p">
                    <div class="progress-box text-center">
                        ...
                        <h5 class="text-light-green padding-top-10 h5">Vendas Feitas</h5>
                        <span class="d-block">75% Percentagem <i class="fa text-light-green fa-line-chart"></i></span>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 mb-30">
                <div class="card-box pd-30 height-100-p">
                    <div class="progress-box text-center">
                        ...
                        <h5 class="text-light-orange padding-top-10 h5">Novos clientes</h5>
                        <span class="d-block">90% Percentagem <i class="fa text-light-orange fa-line-chart"></i></span>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 mb-30">
                <div class="card-box pd-30 height-100-p">
                    <div class="progress-box text-center">
                        ...
                        <h5 class="text-light-purple padding-top-10 h5">Solicitações Pendentes</h5>
                        <span class="d-block">65% Percentagem <i class="fa text-light-purple fa-line-chart"></i></span>
                    </div>
                </div>
            </div>
        </div>
